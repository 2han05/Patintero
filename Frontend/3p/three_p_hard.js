 const canvas = document.getElementById("game");
    ...
    function initGame() {
      runners = [
        { x: area.x + area.w / 3, y: area.y + area.h - 20, r: 14, speed: 5, color: "blue", keys: { up:"ArrowUp", down:"ArrowDown", left:"ArrowLeft", right:"ArrowRight", power:"1" }, reachedTop:false, active:true, poweringUp:false, powerTimer:0, usedPower:false },
        { x: area.x + area.w / 2, y: area.y + area.h - 20, r: 14, speed: 5, color: "green", keys: { up:"w", down:"s", left:"a", right:"d", power:"q" }, reachedTop:false, active:true, poweringUp:false, powerTimer:0, usedPower:false },
        { x: area.x + 2*area.w / 3, y: area.y + area.h - 20, r: 14, speed: 5, color: "purple", keys: { up:"i", down:"k", left:"j", right:"l", power:"u" }, reachedTop:false, active:true, poweringUp:false, powerTimer:0, usedPower:false }
      ];
